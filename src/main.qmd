...
df_yield_channel |> 
  drop_na() |> 
  filter(parameter %in% c("specs", "burn", "final")) |> 
  ...
  gt() |> 
  tab_header(title = "LD-level Yield")
...
## pre burn-in parametric results
...
## post burn-in parameteric results
